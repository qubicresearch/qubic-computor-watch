...
const HUBS = [
  ...
  ['CLJHHZVRWA (SafeTrade1 exchange)', 'CLJHHZVRWAVBEAECXMCEIZOZOJLAMWCQMNYXXHQXOBGRUCXKVZCMBQECQJPE', 'MinerLab/JetSki'],
...
const NEXT_HOP = {
  ...
  'JJAKPG': ['KCOB (relay)'],
  'TZRLYH': ['KCOB (relay)'],
  'KCOB (relay)': ['CLJHHZVRWA (SafeTrade1 exchange)'],
  'CLJHHZVRWA (SafeTrade1 exchange)': ['BBMMA (relay)'],
